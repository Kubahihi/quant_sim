...
The UI compounds sufficiently complete calendar-year asset returns, samples
...
interval measures simulation proportion uncertainty; it is not a confidence
interval for the true future success probability.
